...
class Ajax_pagination {
    ...
    var $last_link = 'Last';
    var $uri_segment = 3;
    var $full_tag_open = '<ul class="pagination text-center col-md-12">';
    ...
    function create_links() {
        ...
        if ($num_pages == 1) {
            //$info = 'Showing  result: ' . $this->total_rows;
            $info = '';
            return $info;
        }
            ...
            function getData(page) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('html,body').animate({ scrollTop: $("<?php echo $this->target; ?>").offset().top-120 }, 0); 
                    }
                });
            }
        </script>
