                    ...
                    <div class="container-fluid">
                        <div class="row page-title">
                            <div class="col-md-12">
                                ...
                                <h4 class="mb-1 mt-0">Section-4</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mt-0 mb-1">Short review of the show <br>
                                          <br>
                                  </h4>
                                  <div class="table-responsive">
                                            <table class="table m-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <td width="45%">Primary thumbnail of the show</td>
                                                      <td width="55%">Upload</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Short Video explainer</td>
                                                        <td><div class="form-group row">
                                                        <label class="col-lg-2 col-form-label"
                                                            for="example-fileinput">Upload</label>
                                                        <div class="col-lg-10">
                                                    ...
                                                    <tr>
                                                        <td>Some  of the screen shots </td>
                                                      <td><div class="form-group row">
                                                        <label class="col-lg-2 col-form-label"
                                                            for="example-fileinput">Upload</label>
                                                        <div class="col-lg-10">
