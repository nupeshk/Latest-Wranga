                    ...
                    <div class="container-fluid">
                        <div class="row page-title">
                            <div class="col-md-12">
                                ...
                                <h4 class="mb-1 mt-0">Reviewer</h4>
                            </div>
                        </div>
                        <br><br><!--<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-error">Create New Admin/Team Leader/Reviewer</button>--><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-error" style="float: right;">Create New Reviewer</button>
                        <br><br><br>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                      ...
                                      <h4 class="header-title mt-0 mb-1">Reviewer</h4>
                                ...
                                <?php $sn=1;foreach ($reviewer as $key => $admin) {?>
                                                ...
                                                <tr>
                                                  ...
                                                  <td><?=$admin->created_at?></td>
                                                   ...
                                                   <td> <div align="center" style="float:left;"><a href="http://wranga.in/index.php/demo/welcome/delete/cms_admin/<?=$admin->id?>/reviewer.html"><i data-feather="trash-2" style="color: #ff000f;" onclick="return confirm('Are you sure you want to delete this item?');"></i> </a></div></td>
                                                </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="width: 705px;">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel"> View Reviewer</h5>
