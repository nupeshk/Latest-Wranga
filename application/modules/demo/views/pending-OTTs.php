                            ...
                            <div class="col-md-12">
                                <nav aria-label="breadcrumb" class="float-right mt-1">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Pending OTTs</li>
                                    </ol>
                                </nav>
                                <h4 class="mb-1 mt-0">Pending OTTs</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                      ...
                                      <h4 class="header-title mt-0 mb-1">Pending OTTs</h4>
                                   ...
                                   <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                            <thead>
                                                <tr>
                                                  ...
                                                  <th>Name</th>
                                                    <th>Uploaded Date</th>
                                                    <th><div align="center">Publish</div></th>
                                            ...
                                            <tbody>
                                                <tr>
                                                  ...
                                                  <td>Tiger Nixon</td>
                                                    ...
                                                    <td>Edinburgh</td>
                                                    <td><div align="center"><a href="javascript:void(0);"><i data-feather="check-circle" style="color:#00CC00"></i> </a></div></td>
