...
<html lang="en">
    ...
    <body class="authentication-bg">
                                    ...
                                    <div class="col-md-6 p-5">
                                        <div class="mx-auto mb-5">
                                            <a href="dashboard.html">
                                                <img src="<?php echo base_url() . PUBLIC_ABS; ?>assets/images/logo-log.png" alt="" height="24" />
                                        ...
                                        <form action="" method="POST" class="authentication-form">
                                            ...
                                            <div class="form-group mb-0 text-center">
                                                <input name="submit" type="submit" class="btn btn-md btn-custom btn-block" value="Log in">
                                            </div>
                                        </form>
                                        <div class="py-3 text-center"><span class="font-size-16 font-weight-bold"></span></div>
                                        <div class="row">
                                            <!--<div class="col-6">
        ...
        <!-- App js -->
        <script src="<?php echo base_url() . PUBLIC_ABS; ?>Fassets/js/app.min.js"></script>
