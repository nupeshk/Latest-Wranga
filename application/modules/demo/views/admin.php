            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <br><br><!--<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-error">Create New Admin/Team Leader/Reviewer</button>--><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-error" style="float: right;">Create New Administrator</button>
                        <br><br><br>
                                            ...
                                            <option selected>Administrator</option>
                                                   ...
                                                   <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input class="form-control" type="adhar" name="adhar" id="adhar" placeholder="Adhar">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-2 col-form-label"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-10">
                                                            <input type="submit" class="btn btn-success width-sm" value="Sumit">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                      ...
                                      <h4 class="header-title mt-0 mb-1">Administrator</h4>
                                ...
                                <?php $sn=1;foreach ($admin as $key => $admin) {?>
                                                ...
                                                <tr>
                                                  ...
                                                  <td><?=$admin->created_at?></td>
                                                    <!--<td><div align="center" style="float:right"><a href="javascript:void(0);"><i data-feather="edit"></i> </a></div></td>-->
                                                    ...
                                                    <td> <div align="center" style="float:left;"><a href="http://wranga.in/index.php/demo/welcome/delete/cms_admin/<?=$admin->id?>/admin.html"><i data-feather="trash-2" style="color: #ff000f;" onclick="return confirm('Are you sure you want to delete this item?');"></i> </a></div></td>
                                                </tr>
                                        ...
                                        <div id="myModal<?=$sn?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="width: 705px;">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="myModalLabel"> View Administrator</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="post" action="http://wranga.in/index.php/demo/welcome/updateProfile">
                                            <input type="hidden" name="id" value="<?=$admin->id?>">
                                            <input type="hidden" name="url" value="admin.html">
