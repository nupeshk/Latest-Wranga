                    ...
                    <div class="col-xl-10">
                            ...
                            <div class="card-body p-0">
                                <div class="row">
                                        ...
                                        <form action="#" class="authentication-form">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="email" class="form-control" id="email" placeholder="hello@abc.com">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6 d-none d-md-inline-block">
                                        <div class="auth-page-sidebar" style="background-image:url(assets/images/stater-bg-pw.png)">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="index.html" class="text-primary font-weight-bold ml-1">Login</a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
