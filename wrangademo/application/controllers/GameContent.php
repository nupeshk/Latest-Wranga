...
class GameContent extends CI_Controller {
	...
	public function rating($id=NULL){
		...
		/**
		 * Calculation Rating and score for safty Features
		 */
		if(isset($postDataArr['SafetyFeatures'])){
			unset($postDataArr['SafetyFeatures']);
			...
			$this->Common->deleteOther($id,12);
			for ($i=0; $i <=11 ; $i++) { 
				$postDataArrMenu['contentId']=$id;
				$postDataArrMenu['ratingCalCategoryId']=$postDataArr['ratingCalCategoryId'];
				$postDataArrMenu['ratingCalSubCategoryId']=47+$i;
				$postDataArrMenu['value']=$postDataArr['SafetyFeatures'.$i];
				$this->Common->insert('wrng_contentthematicrating',$postDataArrMenu);	
			}						
			 $sumSafetyFeatures=$this->Common->selectData('wrng_contentthematicrating', $fld = 'SUM(`value`) as value',['contentId'=>$id,'ratingCalCategoryId'=>'12']);
			 ...
			 $postDataArrr['reatingCalCategoryId']=12;
			 $this->Common->deletemoralBoard($id,12);		
		 ...
		 * Risk to Privacy
		 */
		if(isset($postDataArr['RisktoPrivacy'])){
			unset($postDataArr['RisktoPrivacy']);
			$postDataArrr['desc']=$postDataArr['desc'];
			unset($postDataArr['desc']);
			//	$wrng_reatingcalsubcategory=$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>'1']);		
			$this->Common->deleteOther($id,13);
			for ($i=0; $i <18; $i++) { 
				$postDataArrMenu['contentId']=$id;
				$postDataArrMenu['ratingCalCategoryId']=$postDataArr['ratingCalCategoryId'];;
				$postDataArrMenu['ratingCalSubCategoryId']=59+$i;
				$postDataArrMenu['value']=$postDataArr['RisktoPrivacyValue'.$i];
				$this->Common->insert('wrng_contentthematicrating',$postDataArrMenu);	
			}

			$sumRisktoPrivacy=$this->Common->selectData('wrng_contentthematicrating', $fld = 'SUM(`value`) as value',['contentId'=>$postDataArr['ratingCalCategoryId'],'ratingCalSubCategoryId'=>'13']);
			$postDataArrr['ratning']=$this->ratingCalculation($sumRisktoPrivacy[0]->value);
			#$postDataArrr['ratningScore']=$sumRisktoPrivacy[0]->value;
			$postDataArrr['contentId']=$id;
			$postDataArrr['reatingCalCategoryId']=13;
			$this->Common->deletemoralBoard($id,13);		
			$moralboardId=$this->Common->insert('moralBoard',$postDataArrr);	
			$this->calculationOfFinalRating($id);
		}
		...
		if($postDataArr['PositiveLearningSubmit']){
			unset($postDataArr['PositiveLearningSubmit']);
			$postDataArrr['desc']=$postDataArr['desc'];
			unset($postDataArr['desc']);
			//	$wrng_reatingcalsubcategory=$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>'1']);		
			$this->Common->deleteOther($id,14);
			for ($i=0; $i <5; $i++) { 
				$postDataArrMenu['contentId']=$id;
				$postDataArrMenu['ratingCalCategoryId']=$postDataArr['ratingCalCategoryId'];
				$postDataArrMenu['ratingCalSubCategoryId']=77+$i;
				$postDataArrMenu['value']=$postDataArr['PositiveLearningValue'.$i];
				$this->Common->insert('wrng_contentthematicrating',$postDataArrMenu);	
			}
			$sumPositiveLearning=$this->Common->selectData('wrng_contentthematicrating', $fld = 'SUM(`value`) as value',['contentId'=>$postDataArr['ratingCalCategoryId'],'ratingCalSubCategoryId'=>'14']);
			$postDataArrr['ratning']=$this->ratingCalculation($sumPositiveLearning[0]->value);
			#$postDataArrr['ratningScore']=$sumRisktoPrivacy[0]->value;
			$postDataArrr['contentId']=$id;
			$postDataArrr['reatingCalCategoryId']=14;
			$this->Common->deletemoralBoard($id,14);		
			$moralboardId=$this->Common->insert('moralBoard',$postDataArrr);	
			$this->calculationOfFinalRating($id);
		}
		...
		if(isset($postDataArr['RisktoPrivacy'])){
			...
			$sumRisktoPrivacy=$this->Common->selectData('wrng_contentthematicrating', $fld = 'SUM(`value`) as value',['contentId'=>$postDataArr['ratingCalCategoryId'],'ratingCalSubCategoryId'=>'15']);
			$postDataArrr['ratning']=$this->ratingCalculation($sumRisktoPrivacy[0]->value);
			#$postDataArrr['ratningScore']=$sumRisktoPrivacy[0]->value;
			$postDataArrr['contentId']=$id;
			$postDataArrr['reatingCalCategoryId']=15;
			$this->Common->deletemoralBoard($id,15);		
			$moralboardId=$this->Common->insert('moralBoard',$postDataArrr);	
			$this->calculationOfFinalRating($id);
		}

		/**
		 * Negative Features 15
		 */
		
		if($postDataArr['NegativeFeaturesSubmit']){
			unset($postDataArr['NegativeFeaturesSubmit']);
			$postDataArrr['desc']=$postDataArr['desc'];
			unset($postDataArr['desc']);
			//	$wrng_reatingcalsubcategory=$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>'1']);		
			$this->Common->deleteOther($id,15);
			for ($i=0; $i <8; $i++) { 
				$postDataArrMenu['contentId']=$id;
				$postDataArrMenu['ratingCalCategoryId']=$postDataArr['ratingCalCategoryId'];;
				$postDataArrMenu['ratingCalSubCategoryId']=82+$i;
		...
		if($postDataArr['PositiveLearningSubmitNew']){
			$postDataArr['ratingCalCategoryId']=25;
			...
			$postDataArr['ratingCalCategoryId']=25;
			//	$wrng_reatingcalsubcategory=$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>'1']);		
			$this->Common->deleteOther($id,25);
			for ($i=0; $i <8; $i++) { 
				$postDataArrMenu['contentId']=$id;
				$postDataArrMenu['ratingCalCategoryId']=$postDataArr['ratingCalCategoryId'];
				$postDataArrMenu['ratingCalSubCategoryId']=171+$i;
				$postDataArrMenu['value']=$postDataArr['ProhibitiveCategoryGame'.$i];
				$this->Common->insert('wrng_contentthematicrating',$postDataArrMenu);	
			}
			$sumRisktoPrivacy=$this->Common->selectData('wrng_contentthematicrating', $fld = 'SUM(`value`) as value',['contentId'=>$postDataArr['ratingCalCategoryId'],'ratingCalSubCategoryId'=>'25']);
			$postDataArrr['ratning']=$this->ratingCalculation($sumRisktoPrivacy[0]->value);
			#$postDataArrr['ratningScore']=$sumRisktoPrivacy[0]->value;
			$postDataArrr['contentId']=$id;
			$postDataArrr['reatingCalCategoryId']=25;
			$this->Common->deletemoralBoard($id,25);		
			$moralboardId=$this->Common->insert('moralBoard',$postDataArrr);	
			$this->calculationOfFinalRating($id);	
		}
...
$data['SafetyFeaturesRating'] =$this->Common->selectData('moralBoard', $fld = '*',['contentId'=>$id,'reatingCalCategoryId'=>12]);
$data['RisktoPrivacyRating'] =$this->Common->selectData('moralBoard', $fld = '*',['contentId'=>$id,'reatingCalCategoryId'=>13]);
$data['PositiveLearningRating'] =$this->Common->selectData('moralBoard', $fld = '*',['contentId'=>$id,'reatingCalCategoryId'=>14]);
$data['NegativeFeaturesRating'] =$this->Common->selectData('moralBoard', $fld = '*',['contentId'=>$id,'reatingCalCategoryId'=>15]);	
$data['ProhibitiveCategoryRating'] =$this->Common->selectData('moralBoard', $fld = '*',['contentId'=>$id,'reatingCalCategoryId'=>16]);
		...
		if(isset($postDataArr['submitGameRating'])){	
		...
		$data['SafetyFeatures'] =$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>12]);
		$data['RiskToPrivacy'] =$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>13]);
		$data['PositiveLearning'] =$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>14]);
		$data['NegativeFeatures'] =$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>15]);
		$data['ProhibitiveCategoryGame'] =$this->Common->selectData('wrng_reatingCalSubCategory', $fld = '*',['parent'=>25]);
		$this->load->view('game-rating',$data);
	}
	...
	if($postDataArr){	
		...
		$this->load->view('game-short-review',$data);
	...
	public function tipsandTricks(){
		...
		$data['platform'] =$this->Common->selectData('platform');
		$data['content'] = $this->Common->selectData('content','*',['contentId'=>$this->uri->segment(2)]);
		$this->load->view('game-tips-and-tricks',$data);
	}
	...
	function contentStatusActivate(){
			...
			if($data){
				header("location:".base_url_index.'upload-new-games/'.$id);
			}	
	}
	...
	function userStatusActivate(){
		...
		function pgStatusActivate(){
			...
			if($data){
				header("location:".base_url_index.'rating/'.$id);
			}	
		}
