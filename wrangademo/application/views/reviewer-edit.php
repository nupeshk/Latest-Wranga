...
<script src="<?php echo base_url('js/lib/jquery/jquery.min.js'); ?>" type="text/javascript"></script>
</head>
<body>
...
<h3 style="margin-top:30px;"><strong>Edit Reviewer</strong><div class="fs-subtitle" align="center" style="font-weight:normal;font-size:16px;width:90%;margin-left:5%;"></div> </h3>
</div>

<div class="container" style="width:100%;" >
<form action="<?php echo base_url_index.'update_reviewer/'.$this->uri->segment(2); ?>" method="post" onSubmit="return checkSignatureStatus();" autocomplete="off" enctype="multipart/form-data" >
...
<input type="hidden" name="user_type" value="<?php echo "4"; ?>"></td>
</tr>
<tr>
