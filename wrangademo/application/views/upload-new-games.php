...
<li class="nav-item">
  <a class="nav-link" href="<?php echo base_url_index.'games-published'; ?>">
    <span class="menu-title"><i class="mdi mdi-arrow-left"></i> Back To GAMES</span>
  </a>
</li>
...
<div class="card mb-1">
              ...
              <div class="form-group row">
                  <label class="col-lg-2 col-form-label">Name of Game</label>
                  <div class="col-lg-10">
                ...
                <div class="form-group row">
                  <label class="col-lg-2 col-form-label">Select Game Language</label>
                  <div class="col-lg-10">
          ...
          <script type="text/javascript">
            function showDiv(select){
               if(select.value==3){
                ...
                <div class="form-group row">
                  <label class="col-lg-2 col-form-label">Name of Game Devlopers</label>
                  <div class="col-lg-10">
                    <input type="text" class="form-control" required="required" id="editorName" placeholder="Enter Devlopers name" name="editorName" value="<?=$content[0]->editorName?>">
                  </div>
                </div-->
...
<?php } ?>
                   ...
                   <?php if($content[0]->thumbnailImage!=""){?>
                      <img src="<?=SITE_URL?>assets/thumbnailImage/<?=$content[0]->thumbnailImage?>" width="100">
