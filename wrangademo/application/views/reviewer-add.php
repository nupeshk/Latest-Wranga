...
<div style="text-align:right"><h5><a class="services-ico" href="<?php echo base_url_index.'reviewerprocess'; ?>">&lt;&lt; Back</a></h5></div>
...
<h3 style="margin-top:30px;"><strong>Add Reviewer</strong><div class="fs-subtitle" align="center" style="font-weight:normal;font-size:16px;width:90%;margin-left:5%;"></div> </h3>
</div>

<div class="container" style="width:100%;" >
<form action="<?php echo base_url_index.'revieweraddInsert'; ?>" method="post" onSubmit="return checkSignatureStatus();" autocomplete="off" enctype="multipart/form-data" >
<!-- Begin Name and address of person/entity making the complaint: -->
<div class="container" style="font-size:16px;">
<div class="col-md-12 col-sm-12 col-xs-12">
<div  align="center" style="font-weight:bold;color:red;"><?php if(isset($error)) { echo $error ;} ?></div>
...
<input type="text" class="form-control" name="name" title="Name" placeholder="Name" required ></td>
<td style="padding:1%;text-align:center;">
<input type="email" name="email" class="form-control" title="Email" placeholder="Email"  required >
<input type="hidden" value="4" name="user_type"></td>
</tr>
<tr>
...
<tr>
<td style="padding:1%;text-align:center;">
<input type="password" class="form-control" id="password" name="password" placeholder="Password" required=""></td>
<td style="padding:1%;text-align:center;">
<input class="form-control" type="phone" name="phone" id="phone" onkeypress="return isNumberKey(event);" maxlength="10" placeholder="Phone" required=""></td>
</tr>
...
<tr>
<td style="padding:1%;text-align:center;">
<textarea class="form-control" rows="3" name="address" placeholder="Address" required=""></textarea></td>
<td style="padding:1%;text-align:center;">
<input type="text" class="form-control" name="pan" placeholder="PAN" required></td>
</tr> -->
<tr>
...
<tr>
<!-- <td style="padding:1%;text-align:center;">
<input class="form-control" type="adhar" name="adhar" id="adhar" placeholder="Adhar" required></td> -->
<td style="padding:1%;text-align:center;">
<input type="file" class="form-control"  name="photo" placeholder="Photo" accept="image/*" data-max-size="2048"></td>
</tr>
<tr>
<th style="padding:1%;text-align:center;">Teamleader</th>
<th style="padding:1%;text-align:center;">Comments</th>
</tr>
<tr>
<td style="padding:1%;text-align:center;">
<select name="parent_type" id="parent_type" placeholder="Select Teamleader" title="Select Teamleader" class="form-control" required >
<option value="">Select Teamleader</option>
<?php foreach($this->user_database->getuserList('3') as $usr){ ?>
<option value="<?php echo $usr->id; ?>"><?php echo $usr->name; ?></option>
<?php } ?>
</select></td>
<td style="padding:1%;text-align:center;">
<textarea class="form-control" rows="5" name="comment" placeholder="Comment"></textarea></td>
</tr>
