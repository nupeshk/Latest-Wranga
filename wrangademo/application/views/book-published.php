  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create New ADVISORY</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <select id="inputState" name="languageId" class="form-control">
              <option value="" selected>--- Select Advisory Language --</option>
        ...
        <div class="form-group row">
          <label for="inputPassword3" class="col-sm-4 col-form-label">Advisory Name</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" id="inputPassword3" required="required" name="title" placeholder="Advisory Name">
          </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" value="Submit" name="Create">
          ...
          <span style="float: right;"><a data-toggle="modal" data-target="#exampleModal">CREATE NEW Advisory</a></span>
          </h1> 
  ...
  foreach ($content as $key => $content) {?>
    <tr role="row" class="odd" id="<?=$content->statusId?>">
      ...
      <td>
        ...
        <a href="<?php echo base_url_index; ?>upload-new-book/<?=$content->contentId?>"><i class="mdi mdi-pencil unpbsh"></i></a>

        <a href="<?php echo base_url_index; ?>BOOKContent/deleteId/content/<?=$content->contentId?>/book-published" onclick="return confirm('Are you sure?');"><i class="mdi mdi-delete unpbsh"></i></a>
