...
<div class="mainsec"> 
<h1>Language
<span><a data-toggle="modal" data-target="#exampleModal" class="rightpop">New Language</a></span>
</h1> 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group row">
          <div class="col-sm-12">
            <input type="text" name="lName" class="form-control" placeholder="Enter Language Name">
          </div>
        </div>

        <div class="modal-footer">
          <input type="submit" name="submit" class="btn btn-primary" value="Submit Language">
        </div>
...
<?php  $sn=1; 
      foreach ($wrng_language as $key => $wrng_language) {
  ?>
    <tr role="row" class="odd">
      <td><?=$sn?></td>
      <td><?=$wrng_language->lName?></td>
      <td><?=$wrng_language->createdat?></td>
      <td>
        <a data-toggle="modal" data-target="#exampleModal<?=$sn?>" href="15 "><i class="mdi mdi-pencil"></i></a>
        <a href="http://localhost/WrangaWeb/wrangademo/index.php/OttContent/categoriesDeleteAll/wrng_language/<?=$wrng_language->lId?>/language/lId"><i class="mdi mdi-delete"></i></a>
      </td>
    </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="" enctype="multipart/form-data">
          <div class="form-group row">
          <div class="col-sm-12">
           <input type="hidden" name="lId" value="<?=$wrng_language->lId?>">
            <input type="text" name="lName" class="form-control" value="<?=$wrng_language->lName?>">
          </div>
        </div>

        <div class="modal-footer">
          <input type="submit" name="submitUpdate" class="btn btn-primary" value="Update Language">
        </div>
        </form>
    </div>
  </div>
