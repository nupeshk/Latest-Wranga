...
<div style="text-align:right"><h5><a class="services-ico" href="<?php echo base_url_index.'adminprocess'; ?>">&lt;&lt; Back</a></h5></div>
...
<h3 style="margin-top:30px;"><strong>Add Administrator</strong><div class="fs-subtitle" align="center" style="font-weight:normal;font-size:16px;width:90%;margin-left:5%;"></div> </h3>
</div>

<div class="container" style="width:100%;" >
<form action="<?php echo base_url_index.'adminaddInsert'; ?>" method="post" onSubmit="return checkSignatureStatus();" autocomplete="off" enctype="multipart/form-data" >
...
<input type="hidden" value="1" name="user_type"><input type="hidden" value="" name="parent_type"></td>
</tr>
<tr>
...
<tr>
<th colspan="2" style="padding:1%;text-align:center;">Comments</th>
</tr>
<tr>
<td colspan="2" style="padding:1%;text-align:center;">
