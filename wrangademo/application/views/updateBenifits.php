...
<div class="card mb-1">
              ...
              <div class="card-body text-muted">
                ...
                <div class="form-group row">
                  <label class="col-lg-2 col-form-label">benifitsTitle</label>
                  <div class="col-lg-10">
                    <input type="text" class="form-control" required="required" id="planName" value="<?=$content[0]->benifitsTitle?>" name="benifitsTitle">
                  </div>
                </div>
               
                <div class="form-group row">
                  <label class="col-lg-2 col-form-label">paymentPlanId</label>
                  <div class="col-lg-10">
                    <input type="text" id="basic-datepicker" class="form-control" required="required" placeholder="Plan Amount" name="paymentPlanId" value="<?=$content[0]->paymentPlanId?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="text" id="basic-datepicker" class="form-control" required="required" placeholder="Plan Amount" name="status" value="<?=$content[0]->status?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-10">
                    <input type="submit" class="btn btn-primary" name="submitBenifits" value="Submit">
                  </div>
                </div>
              </div>
</div>
