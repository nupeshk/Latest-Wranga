      ...
      <div class="row">
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
          <div class="card col-lg-4 mx-auto">
		   <form method="post" action="<?php echo base_url_index.'loginprocess'; ?>" onSubmit="return frmValidation();">
            <div class="card-body px-5 py-5">
              ...
              <span style="color:red;font-weight:bold;height:20px;padding-bottom:1%;">&nbsp;&nbsp;&nbsp;<?php if(isset($error)){ echo $error;} ?></span>
                <div class="form-group" style="position: relative;">
                  ...
                  <div class="emailicon"><i class="mdi mdi-email-outline"></i></div> <input type="text" name="user_name" id="user_name" placeholder="hello@abc.com" class="form-control p_input" required>
                </div>
                <div class="form-group" style="position: relative;">
                  <label><b>Password</b> *</label>
                  <div class="emailicon"><i class="mdi mdi-lock"></i></div> <input  type="password" name="pass" id="pass" placeholder="Enter Your Password"  class="form-control p_input" required>
                </div>
                <div class="form-group d-flex align-items-center justify-content-between">
                  ...
                  <a href="<?php echo base_url_index.'forgetPassword'; ?>" class="forgot-pass">Forgot your password?</a>
                </div>
