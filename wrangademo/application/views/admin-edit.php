...
<h3 style="margin-top:30px;"><strong>Edit Administrator</strong><div class="fs-subtitle" align="center" style="font-weight:normal;font-size:16px;width:90%;margin-left:5%;"></div> </h3>
</div>

<div class="container" style="width:100%;" >
<form action="<?php echo base_url_index.'update_admin/'.$this->uri->segment(2); ?>" method="post" onSubmit="return checkSignatureStatus();" autocomplete="off" enctype="multipart/form-data" >
...
<input type="hidden" name="user_type" value="<?php echo "2"; ?>"><input type="hidden" value="" name="parent_type"></td>
</tr>
<tr>
...
<textarea class="form-control" rows="5" name="comment" placeholder="Comment"><?php echo $address; ?></textarea></td>
</tr>
