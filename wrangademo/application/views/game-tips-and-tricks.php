  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create New Tips and Tricks For Game</h5>
...
<?php if(!empty($wrng_tipslist)){
foreach ($wrng_tipslist as $wrng_tipslist) {?>
    <tr role="row" class="odd">
      <td><img src="<?=base_url()?>assets/photo/<?=$wrng_tipslist->videoThumbnailImage?>" width="50" style="width: 56% !important;"></td>
      ...
      <td><div class="unpbsh-box"><a href="<?php echo base_url_index;?>GameContent/tipsDelete/wrng_tipsList/<?=$wrng_tipslist->id?>/game-tips-and-tricks/<?=$id?>"><i class="mdi mdi-delete"></i></a></div></td>
    </tr>
