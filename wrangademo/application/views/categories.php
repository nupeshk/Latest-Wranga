  ...
  ?>
    ...
    <tr role="row" class="odd">
      ...
      <td>
        ...
        <a href="http://localhost/WrangaWeb/wrangademo/index.php/OttContent/categoriesDelete/subCatagories/<?=$subCatagories->subId?>/categories/"><i class="mdi mdi-delete"></i></a>
