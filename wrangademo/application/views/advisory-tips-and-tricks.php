...
<li class="nav-item">
  <a class="nav-link" href="<?php echo base_url_index.'upload-new-book/'.$id; ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create New Tips and Tricks</h5>
...
<?php if(isset($wrng_tipslist)){
    ...
    <tr role="row" class="odd">
      ...
      <td><div class="unpbsh-box"><a href="<?=$wrng_tipslist->id?> "><i class="mdi mdi-pencil"></i></a></div></td>
       <td><div class="unpbsh-box"><a href="<?php echo base_url_index;?>AdvisoryContent/tipsDelete/wrng_tipsList/<?=$wrng_tipslist->id?>/advisory-tips-and-tricks/<?=$id?>"><i class="mdi mdi-delete"></i></a></div></td>
    </tr>
