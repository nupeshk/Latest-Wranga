...
<h2>Team Leader List<hr style="border: 1px solid #333;background:black; width:40%;"></h2>		 
<h3></h3>
</div>
</div>
</div>
...
<a class="services-ico" href="<?php echo base_url_index.'teamleaderadd'; ?>" title="Add New Team Leader">	
<i class="glyphicon glyphicon-plus">
</i>Add New Team Leader</a><br /> 
</h5> 
</div>
</div>
</div>
...
<td style='text-align:center;'><?php if($this->session->userdata('userType')=='1') { ?><a href="<?php echo base_url_index.'teamleaderedit/'.$val->id; ?>"><i class="mdi mdi-tooltip-edit"></i></a><?php } ?></td>
<td style='text-align:center;'>
...
function myFunction1() { 
	...
	$('#myModa22').modal("hide");
	var urlI='<?php echo base_url(); ?>deleteteamleader/'+condemnId;
