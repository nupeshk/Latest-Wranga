...
<div class="mainsec"> 
<h1>OTT Platform Type
<span><a data-toggle="modal" data-target="#exampleModal" class="rightpop">New OTT Platform Type</a></span>
</h1> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create OTT Platform Type</h5>
...
<form method="post" action="" enctype="multipart/form-data">
  <div class="form-group row">
          <div class="col-sm-12">
            <input type="text" name="title" class="form-control" placeholder="Enter OTT Platform Type Name">
          </div>
        </div>
         <div class="form-group row">
          <div class="col-sm-12">
        ...
        <div class="modal-footer">
          <input type="submit" name="submit" class="btn btn-primary" value="Submit OTT Platform Type">
        </div>
...
<?php  $sn=1; 
      foreach ($wrng_ottPlatformType as $key => $wrng_ottPlatformType) {
  ?>
    <tr role="row" class="odd">
      <td><?=$sn?></td>
      <td><?=$wrng_ottPlatformType->title?></td>
      <td><img src="http://localhost/WrangaWeb/wrangademo/assets/ooTType/<?=$wrng_ottPlatformType->image?>" style="width: 150px"></td>
      <td><?=$wrng_ottPlatformType->created_at?></td>    
      <td>
       <a data-toggle="modal" data-target="#exampleModal<?=$sn?>" href="15 "><i class="mdi mdi-pencil"></i></a> 
        <a href="http://localhost/WrangaWeb/wrangademo/index.php/OttContent/categoriesDeleteAll/wrng_ottPlatformType/<?=$wrng_ottPlatformType->ottPlatformTypeId?>/ott-platform-type/ottPlatformTypeId"><i class="mdi mdi-delete"></i></a>
      </td>
    </tr>
...
<div class="modal fade" id="exampleModal<?=$sn?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Update OTT Platform Type</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
...
<form method="post" action="" enctype="multipart/form-data">
  <div class="form-group row">
          <div class="col-sm-12">
            <input type="hidden" name="ottPlatformTypeId" value="<?=$wrng_ottPlatformType->ottPlatformTypeId?>">
            <input type="text" name="title" class="form-control" value="<?=$wrng_ottPlatformType->title?>">
          </div>
        </div>
         <!-- <div class="form-group row">
          <div class="col-sm-12">
        ...
        <div class="modal-footer">
          <input type="submit" name="submitUpdate" class="btn btn-primary" value="Update OTT Platform Type">
        </div>
