...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group row">
          <div class="col-sm-12">
            ...
            <input type="hidden" name="catgId" value="4">
  ...
  ?>
    ...
    <tr role="row" class="odd">
      ...
      <td>
        ...
        <a href="http://localhost/WrangaWeb/wrangademo/index.php/OttContent/categoriesDelete/subCatagories/<?=$subCatagories->subId?>/book-categories/"><i class="mdi mdi-delete"></i></a>
