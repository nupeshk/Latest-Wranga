...
<div class="mainsec"> 
<h1>Book Language
<span><a data-toggle="modal" data-target="#exampleModal" class="rightpop">New Book Language</a></span>
</h1> 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create Book Language</h5>
  ...
  <div class="form-group row">
          <div class="col-sm-12">
            <input type="text" name="name" class="form-control" placeholder="Enter Book Language Name">
        ...
        <div class="modal-footer">
          <input type="submit" name="submitCategories" class="btn btn-primary" value="Submit Book Language">
        </div>
