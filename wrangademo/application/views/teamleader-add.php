...
<h3 style="margin-top:30px;"><strong>Add Team Leader</strong><div class="fs-subtitle" align="center" style="font-weight:normal;font-size:16px;width:90%;margin-left:5%;"></div> </h3>
</div>

<div class="container" style="width:100%;" >
<form action="<?php echo base_url_index.'teamleaderaddInsert'; ?>" method="post" onSubmit="return checkSignatureStatus();" autocomplete="off" enctype="multipart/form-data" >
...
<input type="hidden" value="3" name="user_type"></td>
</tr>
<tr>
