...
<h2>Administration List<hr style="border: 1px solid #333;background:black; width:40%;"></h2>		 
<h3></h3>
</div>
</div>
</div>
...
<a class="services-ico" href="<?php echo base_url_index.'adminadd'; ?>" title="Add New Administration">	
<i class="glyphicon glyphicon-plus">
</i>Add New Administration</a><br /> 
</h5> 
</div>
</div>
</div>
...
<td style='text-align:center;'>
    <?php if($val->status=='1') { ?>
      ...
      <a href="<?php echo base_url_index.'OttContent/userStatusActivate/0/adminprocess/'.$val->id; ?>" onclick="return confirm('Are you sure you want to Inactive this item?');">Active</a>
    <?php }else{?>
    <a href="<?php echo base_url_index.'OttContent/userStatusActivate/1/adminprocess/'.$val->id; ?>" onclick="return confirm('Are you sure you want to Active this item?');">Inactive</a>
    <?php } ?>
</td>
...
<td style='text-align:center;'><?php if($this->session->userdata('userType')=='1') { ?><a href="<?php echo base_url_index.'adminedit/'.$val->id; ?>"><i class="mdi mdi-tooltip-edit"></i></a><?php } ?></td>
...
function myFunction1() { 
	...
	$('#myModa22').modal("hide");
	var urlI='<?php echo base_url(); ?>deleteadmin/'+condemnId;
