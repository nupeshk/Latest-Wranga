...
<div class="mainsec"> 
<h1>Platform
<span><a data-toggle="modal" data-target="#exampleModal" class="rightpop">New Platform</a></span>
</h1> 
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create Platform</h5>
  ...
  <div class="form-group row">
          <div class="col-sm-12">
            <input type="text" name="name" class="form-control" placeholder="Enter Platform Name">
          </div>
        </div>

        <div class="modal-footer">
          <input type="submit" name="submit" class="btn btn-primary" value="Submit Platform">
        </div>
...
<?php  $sn=1; 
  ...
  ?>
    ...
    <tr role="row" class="odd">
      ...
      <td>
        <!-- <a data-toggle="modal" data-target="#exampleModal1" href="15 "><i class="mdi mdi-pencil"></i></a> -->
        <a href="http://localhost/WrangaWeb/wrangademo/index.php/OttContent/categoriesDeleteAll/platform/<?=$platform->pId?>/platform/pId"><i class="mdi mdi-delete"></i></a>
