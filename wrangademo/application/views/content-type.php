...
<div class="mainsec"> 
<h1>Content Type
<span><a data-toggle="modal" data-target="#exampleModal" class="rightpop">New Content Type</a></span>
</h1> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">     
        ...
        <div class="form-group row">
          <div class="col-sm-12">
            <input type="text" name="name" class="form-control" placeholder="Enter Content Type Name">
          </div>
        </div>
        <div class="modal-footer">
          <input type="submit" name="submit" class="btn btn-primary" value="Submit Content Type">
        </div>
        </form>
    </div>
  </div>
...
<?php  $sn=1; 
      foreach ($wrng_contentType as $key => $wrng_contentType) {
  ?>
    <tr role="row" class="odd">
      <td><?=$sn?></td>
      <td><?=$wrng_contentType->name?></td>
      <td><?=$wrng_contentType->createdat?></td>     
      <td>
        <a data-toggle="modal" data-target="#exampleModal<?=$sn?>" href="15 "><i class="mdi mdi-pencil"></i></a>
        <a href="http://localhost/WrangaWeb/wrangademo/index.php/OttContent/categoriesDeleteAll/wrng_contentType/<?=$wrng_contentType->id?>/content-type/id"><i class="mdi mdi-delete"></i></a></td>
    </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">     
        ...
        <div class="form-group row">
          <div class="col-sm-12">
            <input type="hidden" name="id" class="form-control" value="<?=$wrng_contentType->id?>">
            <input type="text" name="name" class="form-control" value="<?=$wrng_contentType->name?>">
          </div>
        </div>
        <div class="modal-footer">
          <input type="submit" name="submitUpdate" class="btn btn-primary" value="Update Content Type">
        </div>
        </form>
    </div>
  </div>
